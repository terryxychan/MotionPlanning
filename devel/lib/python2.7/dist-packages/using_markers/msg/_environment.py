...
"""autogenerated by genpy from using_markers/environment.msg. Do not edit."""
import sys
...
class environment(genpy.Message):
  _md5sum = "0dbb5e5297239549b759daf57f6ebd35"
  _type = "using_markers/environment"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# this msg of environment is the information that is used as obstacles
Polygon[] Obstacles
...
"""
  __slots__ = ['Obstacles']
  _slot_types = ['using_markers/Polygon[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = using_markers.msg.Polygon()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.Polygon = []
        for i in range(0, length):
          val2 = using_markers.msg.Point2D()
          _x = val2
          start = end
          end += 16
